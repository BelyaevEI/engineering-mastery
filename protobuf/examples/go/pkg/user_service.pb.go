...
const file_user_service_proto_rawDesc = "" +
	"\n" +
	"\x12user_service.proto\x12\x04user\x1a\x1cgoogle/api/annotations.proto\" \n" +
	...
	"\x03age\x18\x04 \x01(\x05R\x03age2V\n" +
	"\vUserService\x12G\n" +
	"\aGetUser\x12\x14.user.GetUserRequest\x1a\n" +
	".user.User\"\x1a\x82\xd3\xe4\x93\x02\x14\x12\x12/api/v1/users/{id}B>Z<github.com/engineering-mastery/protobuf/examples/go/pkg;userb\x06proto3"
